...
from dataset import PbrdfDynamicDatasetBase
...
def opt(rank, world_size, args:edict):
    ...
    for i in range(0, num_total_frames, args.data.num_group_frame):
        ...
        logger.print('--------'*4, write_to_log=True)
        logger.save_ckpt(renderer, f'{args.general.out_dir}/ckpt/s{args.opt.stage}_last_{args.data.start_frame + 1:04d}_{args.data.end_frame + 1:04d}.pt')
...
if __name__=='__main__':
    ...
    print(f'Total {args.data.num_frames}.')
